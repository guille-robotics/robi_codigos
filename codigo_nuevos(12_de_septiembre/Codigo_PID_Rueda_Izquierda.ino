...
void setup()
{
  ...
  motor.setGains(0.22, 0.1, 0.04); // (Kc,Ti,Td) 0.55, 0.10, 0.05   0.25, 0.1, 0.05 Rueda Izquierda = 0.22, 0.21, 0.04
  /*
...
void loop() {
  ...
  {  
     ...
     cvIzquierdo = motor.compute(wRefIzquierda,wIzquierdo); 
