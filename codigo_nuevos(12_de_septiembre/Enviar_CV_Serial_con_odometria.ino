...
void loop() {
  ...
  if (millis() - lastTime >= sampleTime){  
      ...
      velocityRobot(wDerecho, wIzquierdo);
...
//FUNCION CALCULO VELOCIDAD ANGULAR Y LINEAL GENERAL////
void velocityRobot(double w_derecha, double w_izquierda)
{
  uMeas = (R*(w_derecha+w_izquierda))/2.0; 
  wMeas = (R*(w_derecha-w_izquierda))/d;
}
